...
_PHRASES: dict[tuple[str, ...], str] = {
    ...
    ("open", "curly"): "{", ("open", "curly", "brace"): "{",
    ("close", "brace"): "}", ("right", "brace"): "}",
    ("close", "curly"): "}", ("close", "curly", "brace"): "}",
    ("open", "angle"): "<", ("close", "angle"): ">",
    ("less", "than"): "<", ("greater", "than"): ">",
    ("less", "than", "or", "equal"): "<=",
    ("greater", "than", "or", "equal"): ">=",
    ("new", "line"): "\n",
    ("double", "equals"): "==", ("double", "equal"): "==",
    ("triple", "equals"): "===",
    ("not", "equals"): "!=", ("not", "equal"): "!=", ("bang", "equals"): "!=",
...
_WORDS: dict[str, str] = {
    ...
    "equals": "=", "equal": "=", "plus": "+", "minus": "-", "dash": "-",
    "star": "*", "asterisk": "*", "times": "*", "slash": "/", "backslash": "\\",
    "percent": "%", "caret": "^", "tilde": "~", "underscore": "_",
    "hash": "#", "pound": "#", "hashtag": "#", "octothorpe": "#",
    "at": "@", "dollar": "$", "ampersand": "&", "pipe": "|",
    "bang": "!", "exclamation": "!", "backtick": "`",
    "tab": "\t", "newline": "\n", "space": " ",
    "quote": '"', "tick": "'", "apostrophe": "'",
}
...
_KEYWORDS = {
    "if", "elif", "else", "while", "for", "return", "and", "or", "not", "in",
    "with", "assert", "del", "yield", "await", "case", "switch", "raise",
    "import", "from", "lambda", "is",
}
